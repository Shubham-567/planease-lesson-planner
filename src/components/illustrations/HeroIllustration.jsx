...
const HeroIllustration = () => {
  return (
    <div className='relative hidden w-1/2 p-4 md:block'>
      <div className='bg-base-200 p-3 rounded-2xl transform md:-rotate-2 border border-base-300 max-w-lg mx-auto transition-all duration-600 ease-in-out hover:rotate-0 hover:scale-105 hover:shadow-xl'>
