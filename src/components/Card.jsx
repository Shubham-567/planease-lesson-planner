...
const Card = ({ icon, title, description }) => {
  return (
    <div className='flex flex-col items-center gap-3 bg-base-100 p-8 rounded-2xl ring ring-base-300 transition-all duration-300 ease-in-out hover:shadow-xl hover:shadow-primary/10 hover:ring-primary/50 hover:-translate-y-2 hover:-rotate-1'>
